...
PYTHON_INCLUDE_DIR ?= `pkg-config --cflags python2`
...
swig:
	$(SWIG) -Wall -c++ -python -outdir $(OUTDIR) -o $(SRCS) -I.$(PATHSEP)sdk-cpp$(PATHSEP)include -I.$(PATHSEP)sdk-cpp$(PATHSEP)sdk-c$(PATHSEP)include$(PATHSEP) -I.$(PATHSEP)sdk-cpp$(PATHSEP)src -I.$(PATHSEP)sdk-cpp$(PATHSEP)sdk-c$(PATHSEP)build$(PATHSEP) $(PYTHONINCLUDE) swig/core.i
...
python: makedir make_c_sdk remove_so swig $(OBJS) make_lib
	...
	python2 $(OUTDIR)/setup.py build_ext -I.$(PATHSEP)sdk-cpp$(PATHSEP)include -I.$(PATHSEP)sdk-cpp$(PATHSEP)sdk-c$(PATHSEP)include$(PATHSEP) -I.$(PATHSEP)sdk-cpp$(PATHSEP)src -I.$(PATHSEP)sdk-cpp$(PATHSEP)sdk-c$(PATHSEP)build$(PATHSEP) -l kuzzlesdk -b $(OUTDIR) -t $(OUTDIR)/tmp
